...
import numpy as np
import os
from DSSFNet_wograd_model import DSSFNet_wograd
from DSSFNet_wograd_model import Get_gradient
...
if __name__ == '__main__':
    ...
    hsi, p1, option1 = read_and_divide(r'/home/data2/zzl22/DataSet/ZY102D/Scene1', 80, 0.1)
    msi, p2, option2 = read_and_divide(r'/home/data2/zzl22/DataSet/ZY102D/Scene1msi', 240, 0.1)
    print('finish load data')
    

    model = DSSFNet_wograd(148, 8, 3, 10)
    # model = nn.DataParallel(model)
    model_root = './work_dir/DSSFNet_wograd_newupscale_20230523_server_L1loss_5e-5_no5'

    model_path = model_root + '/epoch169.pth'
    ...
    ENVI_IO.envi_write(model_root + '/scene1_0524', allimg)
